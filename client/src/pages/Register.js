            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <Form className="mx-1 mx-md-4" layout='vertical'  onFinish={submitHandler} >
                  ...
                  <div className='lnk' >
                  <Link to='/login' className='' >Already Register ? Click Here to login</Link>
                  </div>

                </Form>
              </div>
              <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                <img src="https://peoplespheres.com/wp-content/uploads/2023/01/expense-management-software.png" className="img-fluid" alt="Sample image" />
              </div>
            </div>
          </div>
        </div>
