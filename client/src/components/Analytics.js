...
const Analytics = ({ allTransection }) => {
    ...
    const totalExpeneseTransections = allTransection.filter(transection => transection.type === 'expense')
    const totalIncomePercent = (totalIncomeTransections.length / totalTransections) * 100;
    const totalExpensePercent = (totalExpeneseTransections.length / totalTransections) * 100;
            ...
            <div className='col-md-4' >
                <div className='card' >
                    ...
                    <div className='card-body' >
                        ...
                        <h5 className='text-danger' >Expense : {totalExpeneseTransections.length}</h5>
                        <div>
                            <Progress 
                                type='circle'
                                strokeColor={'green'}
